...
neededDirectories = ["textures","meshes","meshes/usda","textures/processing","textures/processing/diffuse","textures/processing/roughness","textures/processing/displacements","textures/processing/normaldx","textures/processing/normals","textures/processing/metallness","textures/processing/emission","textures/processing/diffuse",f"{config.rtx_remix_dir}/mods"]
