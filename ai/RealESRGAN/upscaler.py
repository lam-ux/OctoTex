...
def upscaleAll():
    ...
    output_dir = "textures/processing/diffuse/"
    ...
    for idx, path in enumerate(paths):
        ...
        try:
            ...
            shutil.move(f"textures/processing/diffuse/{imgname}.{extension}".replace("..","."), f"textures/processing/diffuse/{imgname}.{extension}".replace("..","."))
