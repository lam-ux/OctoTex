...
for x in tqdm( os.listdir(f"{config.rtx_remix_dir}/mods/gameReadyAssets/SubUSDs/processing/diffuse/"), desc="Generating..." ):
	if x.endswith(".png"):
		generate_normal(
			f"{config.rtx_remix_dir}/mods/gameReadyAssets/SubUSDs/processing/diffuse/{x}",
